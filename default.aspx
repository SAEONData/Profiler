<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="profiler._default" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">SARVA</a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li id="btn_graphFrame" class="pageButton active"><a href="#"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span>&nbsp;Profiler</a></li>
              <li id="btn_searchFrame" class="pageButton"><a href="#"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>&nbsp;Search</a></li>
        ...
        <iframe class="pageFrame" id="graphFrame" name="graphFrame" src="graphs.aspx" style="border: 1px solid #f0f0f0; width: 100%"></iframe>
        <iframe class="pageFrame" id="searchFrame" name="searchFrame" src="search.aspx" style="border: 0px solid #f0f0f0; width: 100%"></iframe>
        <iframe class="pageFrame" id="indicatorFrame" name="indicatorFrame" src="search.aspx" style="border: 0px solid #f0f0f0; width: 100%"></iframe>
